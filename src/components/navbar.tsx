...
const Navbar = () => {
  return (
    <div className="flex justify-between bg-gradient-to-b from-gray-900 to-gray-700 border-b-4 border-indigo-500 bg-gradient-to-r font-serif text-lg drop-shadow-xl rounded ">
