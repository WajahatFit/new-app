...
const Login: React.FC = () => {
  ...
  const graphqlEndpoint =
    "mongodb+srv://soufianebdaoui:ptX8HWxU9DX5Edce@cluster0.xxnivke.mongodb.net/?retryWrites=true&w=majority/graphql";
  ...
  useEffect(() => {
    ...
    axios
      .post<{ data: { currentUser: string } }>(graphqlEndpoint, {
        query: graphqlQuery,
      })
      .then((response) => {
