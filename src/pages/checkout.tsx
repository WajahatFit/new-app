        ...
        <div className="flex flex-col space-y-8">
          ...
          <div>
            <h3 className="text-3xl">
              <span className="tracking-wider">Shipping Details</span>{" "}
            </h3>
          </div>
        </div>
          ...
          <div className="w-1/2 h-full">
            <form action="" className="space-y-8 ">
              ...
              <input
                ...
                type="text"
                placeholder="Apartment, suite, house, etc..."
                id="apartment"
                required
              />
              <div className="flex justify-between gap-6">
                <input
                  className="border-2 border-gray-500 p-2 w-1/3"
                  type="text"
                  placeholder="City"
                  id="city"
                  required
              ...
              <button className="w-full py-4 bg-gray-800 text-white text-xl">
